const features = [
  {
    ...
    description: 'Offering affordable remodeling solutions to our clients is a top priority to us. We provide detailed quotes and are happy to answer any questions you have about pricing.',
    icon: (
  ...
  },
  {
    ...
    description: 'We operate with full transparency by being upfront about our costs. Our free, no-obligation quote lets you know how much your project will cost before you commit.',
    icon: (
      <svg className="w-12 h-12 text-ocean-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Our in-house team of remodeling contractors ensure quality from start to finish. We never cut corners, conduct inspections during construction and provide site walk throughs at completion.',
    icon: (
      <svg className="w-12 h-12 text-ocean-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'From concept to completion, our team provides clear and concise communication that keeps you informed about your project. We also provide timely responses to your questions or concerns.',
    icon: (
      <svg className="w-12 h-12 text-ocean-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
