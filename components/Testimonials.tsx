...
const testimonials = [
  {
    name: 'Sarah M.',
    rating: 5,
    review: "After years of envisioning a modern, functional kitchen, I finally decided to work with Palm Development & Renovation Group. From the initial consultation to the final reveal, the team exceeded all my expectations. They listened carefully to my needs, offered creative and practical solutions, and kept me informed throughout the entire process. The project was completed on schedule and within budget, which was a tremendous relief. My new kitchen is everything I dreamed of and more. It's not only beautiful but also incredibly functional. The craftsmanship is exceptional, and the attention to detail is visible in every aspect. I highly recommend Palm Development & Renovation Group to anyone looking to transform their kitchen. They truly brought my vision to life.",
  },
  {
    name: 'Michael T.',
    rating: 5,
    review: "Selecting Palm Development & Renovation Group for our bathroom renovation was one of the best decisions we've made. Our outdated bathroom desperately needed an upgrade, and the Palm Development & Renovation Group team transformed it into a luxurious retreat. They were professional, knowledgeable, and extremely responsive to all our questions and concerns throughout the process. The design team was excellent, helping us choose materials and fixtures that matched our style and budget perfectly. The craftsmanship is outstanding, and the finished product exceeded our expectations. The project was completed on schedule, and the work area was always kept clean and organized. We are absolutely thrilled with our new bathroom and wouldn't hesitate to use Palm Development & Renovation Group for future projects.",
  },
  {
    name: 'Amanda R.',
    rating: 5,
    review: "We had the pleasure of working with Palm Development & Renovation Group for the construction of our new home, and the experience was absolutely exceptional. From the initial design phase through construction and the final walkthrough, the entire team demonstrated professionalism, expertise, and an unwavering commitment to quality. They were attentive to our vision and worked diligently to bring it to life, offering valuable advice and solutions whenever challenges arose. The project management was excellent, with clear communication and regular updates throughout the process. The end result is a beautiful, well-constructed home that perfectly meets our needs and desires. We are deeply grateful to the Palm Development & Renovation Group team for their hard work and dedication, and we highly recommend their services to anyone looking to build their dream home.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-charcoal-gray mb-6 leading-relaxed">
              Read what our satisfied customers have to say about their experience with Palm Development & Renovation Group. We take pride in our work and consistently strive to provide high-quality services that exceed our customers&apos; expectations. Contact us today to learn more about our services and how we can help transform your home!
            </p>
