...
const steps = [
  ...
  },
  {
    ...
    description: 'Watch your vision come to life as we expertly execute the plan. Our dedicated team ensures a smooth and efficient implementation, bringing your dream space from concept to reality with precision and care. At Palm Development & Renovation Group, your satisfaction is our ultimate goal, and we take pride in delivering results that exceed expectations.',
      ...
      <div className="py-20 px-4 bg-stone-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg text-charcoal-gray max-w-3xl mx-auto leading-relaxed">
            Begin a stress-free journey with Palm Development & Renovation Group as we guide you through four simple steps to bring your dream space to life.
          </p>
        </div>
      </div>
